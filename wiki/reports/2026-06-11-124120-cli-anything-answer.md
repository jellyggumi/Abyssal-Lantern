---
title: "CLI-Anything 설명 & 현재 환경 비교"
created_at: "2026-06-11T12:41:20.070056+00:00"
section: "reports"
status: "captured"
session_id: "52dd9a23-75d2-4469-ba27-aeb83df8"
raw_output: "[[raw/sources/outputs/2026/06/11/124120-52dd9a23-75d-cli-anything]]"
source_summary: "[[wiki/sources/2026-06-11-124120-cli-anything-output]]"
---
...
요약하면: 이 환경은 cli-anything 기준으로 **이미 풀스택 연동 상태**(스킬 + 메타스킬 + MCP 허브)이고, 가장 가까운 친척은 `unity-mcp`(MCP 방식의 소프트웨어 제어)와 `obsidian-cli`(동일 철학의 단일 CLI), 보완재는 `rtk`(출력 압축)와 브라우저 계열(코드 없는 대상용)입니다. 특정 소프트웨어를 에이전트로 다루고 싶으시면 `hub_search`로 바로 레지스트리를 검색해 드릴 수 있습니다.

## Evidence and Citations

- [[wiki/sources/2026-06-11-124120-cli-anything-output]]
- [[raw/sources/outputs/2026/06/11/124120-52dd9a23-75d-cli-anything]]
